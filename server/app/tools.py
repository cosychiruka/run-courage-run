...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            "name": "get_my_tweets",
            "description": (
                "Retrieve @cowardlyhood's recent tweets directly from the X API. "
    ...
    },
    {
        ...
        "function": {
            "name": "get_mentions",
            "description": (
                "Fetch recent mentions and replies to @cowardlyhood on X. "
    ...
    },
    {
        ...
        "function": {
            "name": "get_my_profile",
            "description": (
                "Fetch @cowardlyhood's own Twitter profile info: username, display name, bio, "
