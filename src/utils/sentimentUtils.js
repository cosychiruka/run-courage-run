...
export function getCourageReaction(emotion) {
  const reactions = {
    happy: [
      ...
      "A green signal! *ears perk up* The forest noticed too.",
    ],
    scared: [
      "AAAAAAH! The news! IT'S TOO MUCH! *hides behind couch*",
      "Oh no. Oh no no no. Even the Tickerlings stopped blinking.",
      "I was NOT prepared for this headline. NOT. PREPARED.",
      "*whimpers* Someone hold me. This is very bad for the vibes.",
    ],
    neutral: [
      "Mm. Another signal reached the farmhouse. Courage is listening.",
